...
class TestNoFaults:
    ...
    def test_a(self, interpolator_islith_nofault):
        ...
        # Compute model
        sol = gempytf.compute_model(geo_data)
        ...
        gempytf.plot.plot_section(geo_data, 25, direction='y', show_data=True)
        plt.savefig(os.path.dirname(__file__)+'/../figs/test_a.png', dpi=100)

        gempytf.plot.plot_scalar_field(geo_data, 25)
...
class TestFaults:
    ...
    def test_d(self, interpolator):
        ...
        gempytf.set_series(geo_data, {'fault1': 'f1', 'series': ('A', 'B')})
    ...
    def test_f_sort_surfaces(self, interpolator):
        ...
        # Compute model
        sol = gempytf.compute_model(geo_data, sort_surfaces=True)
        ...
        ver, sim = gempytf.get_surfaces(geo_data)
        print(ver, sim)
